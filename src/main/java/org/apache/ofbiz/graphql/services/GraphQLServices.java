...
public class GraphQLServices {
	...
	public Map<String, Object> buildPageInfo(DispatchContext dctx, Map<String, Object> context){
		...
		int pageMaxIndex = new BigDecimal(totalCount - 1).divide(new BigDecimal(pageSize), 0, BigDecimal.ROUND_DOWN).intValue();
	...
	public Map<String, Object> buildConnection(DispatchContext dctx,
	...
	@SuppressWarnings("unchecked")
	public Map<String, Object> buildConnectionByList(DispatchContext dctx,
			Map<String, Object> context){
